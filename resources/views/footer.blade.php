                        ...
                        <div class="content">
                            <div class="me-4">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="" class="text-decoration-none text-secondary">Games</a></li>
                                    <li><a href="" class="text-decoration-none text-secondary">Videos</a></li>
                                    <li><a href="" class="text-decoration-none text-secondary">News</a></li>
                                </ul>
                                <h4 class="text-white my-3">SHOP</h4>
                                <ul class="list-unstyled">
                                    <li><a href="" class="text-decoration-none text-secondary">Shop DC</a></li>
                            ...
                            <div class="me-4">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="" class="text-decoration-none text-secondary">Ad Choices</a></li>
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-between align-items-center p-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <img src="/public/img/footer-facebook.png" alt="" class="mx-2">
                            <img src="/public/img/footer-twitter.png" alt="" class="mx-2">
                            <img src="/public/img/footer-youtube.png" alt="" class="mx-2">
                            <img src="/public/img/footer-pinterest.png" alt="" class="mx-2">
                            <img src="/public/img/footer-periscope.png" alt="" class="mx-2">
                        </div>
                    </div>
                </div>
            </div>
